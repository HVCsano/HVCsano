![HU](https://raw.githubusercontent.com/stevenrskelton/flag-icon/master/png/75/country-4x3/hu.png)
...
![Skills](https://skillicons.dev/icons?i=windows,linux,debian,ubuntu,vscode,docker,tauri,svelte,vue,nuxt,tailwind,js,ts,vite,nodejs,pnpm,bun,deno,rust,mysql,arduino,electron,git,github,nginx,workers,discord,discordjs)
